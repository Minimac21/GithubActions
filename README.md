[![Run App Mac Holland DePriest](https://github.com/Minimac21/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Minimac21/GithubActions/actions/workflows/run-app.yaml)
